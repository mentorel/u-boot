/*
 * am3517somiq.h - Header file for the AM3517/05 SomIQ 
 *
...
#ifndef _AM3517SOMIQ_H_
#define _AM3517SOMIQ_H_
...
/* DSS */\
 ...
 /* McSPI2 */\
	...
	MUX_VAL(CP(SYS_CLKOUT2),	(IDIS | PTU | EN  | M4)) /*HSUSB1_RST*/\
 /* ETK (ES2 onwards) */\
	MUX_VAL(CP(ETK_CLK_ES2),	(IEN  | PTU | EN  | M3)) /*HSUSB1_STP*/\
	...
	MUX_VAL(CP(ETK_D15_ES2),	(IEN  | PTD | DIS | M4)) /*MMC1_CD*/\
	...
	MUX_VAL(CP(SYS_CLKOUT1),	(IDIS | PTD | EN  | M4)) /* GPIO_10 */\
 /* JTAG */ \
