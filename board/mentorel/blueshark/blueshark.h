...
#define MUX_BLUESHARK() \
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(SYS_CLKREQ),		(IEN  | PTD | DIS | M4)) /*GPIO_1*/\
	...
	MUX_VAL(CP(ETK_D0_ES2),		(IEN  | PTD | EN  | M1)) /*McSPI3_SIMO*/\
	MUX_VAL(CP(ETK_D1_ES2),		(IEN  | PTD | DIS | M1)) /*McSPI3_SOMI*/\
	MUX_VAL(CP(ETK_D2_ES2),		(IEN  | PTD | EN  | M1)) /*McSPI3_CS0*/\
	MUX_VAL(CP(ETK_D3_ES2),		(IEN  | PTU | EN  | M1)) /*McSPI3_CLK*/\
	MUX_VAL(CP(ETK_D4_ES2),		(IEN  | PTU | DIS | M4)) /*GPIO_18*/\
	MUX_VAL(CP(ETK_D5_ES2),		(IEN  | PTU | DIS | M4)) /*GPIO_19*/\
	MUX_VAL(CP(ETK_D6_ES2),		(IDIS | PTD | DIS | M4)) /*GPIO_20*/\
	MUX_VAL(CP(ETK_D7_ES2),		(IEN  | PTU | DIS | M4)) /*GPIO_21*/\
