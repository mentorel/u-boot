/*
 * somiq_am35.h - Default configuration for SomIQ-AM35 SOM.
 *
 * Author: Maxim Podberezny <lisarden@gmail.com>
 *
...
/* silicon errata: multi block reads on cpu versions 2.1
 * and older is broken.  only try multi block reads on
 * versions after 2.1
 */
...
/*-----------------------------------------------------
 * ethernet support for SomIQ module
 *------------------------------------------------
*/
#if defined(CONFIG_CMD_NET)
